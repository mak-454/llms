...
class DKubeAI(LLM, BaseModel):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain.llms.dkubeapi import DKubeAI
            hf = DKubeAI(repo_id="togethercomputer/GPT-JT-6B-v1", dkubeai_ep="http://127.0.0.1:80000", dkubeai_api_token="my-api-key")
    """
    ...
    dkubeai_api_token: Optional[str] = "invincible"
    ...
    def _call(self, prompt: str, stop: Optional[List[str]] = None) -> str:
        ...
        data = {"prompt": prompt, "model_kwargs": self.model_kwargs}
